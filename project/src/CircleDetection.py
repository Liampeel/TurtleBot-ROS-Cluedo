...
class colourIdentifier():
    ...
    def callback(self, data):
        try:
            ...
            contours_green, hierarchy = cv2.findContours(image_mask_green.copy(), cv2.RETR_LIST,
            ...
            circles = cv2.HoughCircles(grey, cv.CV_HOUGH_GRADIENT, 1, 20, param1=50, param2=30, minRadius=90,
                                       maxRadius=110)
